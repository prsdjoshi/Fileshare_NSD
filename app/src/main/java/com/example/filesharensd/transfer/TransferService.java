package com.example.filesharensd.transfer;
...
import com.example.filesharensd.bundle.Bundle;
import com.example.filesharensd.bundle.FileItem;
import com.example.filesharensd.discovery.Device;
import com.example.filesharensd.util.Settings;
...
public class TransferService extends Service {
    ...
    public static final String ACTION_START_LISTENING = "net.share.android.START_LISTENING";
    public static final String ACTION_STOP_LISTENING = "net.share.android.STOP_LISTENING";

    public static final String ACTION_START_TRANSFER = "net.share.android.START_TRANSFER";
    public static final String EXTRA_DEVICE = "net.share.android.DEVICE";
    public static final String EXTRA_URIS = "net.share.android.URLS";
    public static final String EXTRA_ID = "net.share.android.ID";

    public static final String ACTION_STOP_TRANSFER = "net.share.android.STOP_TRANSFER";
    public static final String ACTION_REMOVE_TRANSFER = "net.share.android.REMOVE_TRANSFER";
    public static final String EXTRA_TRANSFER = "net.share.android.TRANSFER";

    public static final String ACTION_BROADCAST = "net.share.android.BROADCAST";
